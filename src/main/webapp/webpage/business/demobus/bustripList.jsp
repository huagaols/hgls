...
<t:datagrid name="bustrip" title="请假列表" actionUrl="busController.do?bustripGrid" idField="id" queryMode="group">
 ...
 <t:dgConfOpt exp="TSPrjstatus_code#eq#new" url="activitiController.do?startBusProcess&businessKey={id}&busconfigKey={TSBusConfig_id}&bpm_biz_title={bustripreson}" message="确认完毕,提交申请?" title="提交申请"></t:dgConfOpt>
