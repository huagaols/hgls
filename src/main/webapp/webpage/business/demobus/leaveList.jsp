...
<t:datagrid name="leave" title="请假列表" actionUrl="busController.do?leaveGrid" idField="id" queryMode="group">
 ...
 <t:dgConfOpt exp="TSPrjstatus_code#eq#new" url="activitiController.do?startBusProcess&businessKey={id}&busconfigKey={TSBusConfig_id}&bpm_biz_title={TSUser_userName}" message="确认提交申请?" title="提交流程"></t:dgConfOpt>
