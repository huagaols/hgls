...
<t:datagrid name="bormoney" title="借款列表" actionUrl="busController.do?bormoneyGrid" idField="id">
 ...
 <t:dgConfOpt exp="TSPrjstatus_code#eq#new" url="activitiController.do?startBusProcess&businessKey={id}&busconfigKey={TSBusConfig_id}&bpm_biz_title={TSUser_userName}" message="确认完毕,提交申请?" title="办理"></t:dgConfOpt>
