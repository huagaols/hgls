...
<t:datagrid name="testZhangTaskList" title="入职审批列表" actionUrl="activitiController.do?taskList&busCode=zhang" idField="id">
 <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
 <t:dgCol title="入职人" field="TSUser_userName"></t:dgCol>
