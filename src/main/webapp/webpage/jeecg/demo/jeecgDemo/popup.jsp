...
<div class="formDetails"><label>用户选择： <input id="myText" readonly="readonly" type="text" class="searchbox-inputtext15" onclick="inputClick(this,'account','user_msg');"> </label> <label>清算期
